...
知识图谱驱动的小说创作辅助平台。
支持百万量级文字，超高并发数，可搭配本地向量模型/本地大语言模型以及向量库进行使用
将你的素材和小说文本转化为可视化的概念网络，帮你理清人物关系、追踪伏笔、检测逻辑漏洞、与角色对话。

![首页入口截图](screenshots/%E6%88%AA%E5%B1%8F2026-07-23%2011.52.17.png)
*首页 — 双模式选择：素材大纲与小说推演*

![图谱可视化截图](screenshots/%E6%88%AA%E5%B1%8F2026-07-23%2012.58.12.png)
*工作台 — D3.js 力导向知识图谱可视化与智能分析面板*
